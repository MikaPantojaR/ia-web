export enum RegistryConstants {
    ...
    NAME_PLACEHOLDER_VALUE = 'Nombre de Paciente',
    NAME_LABEL_VALUE = 'Mikaela Pantoja',

    PASSWORD_PLACEHOLDER_VALUE = 'Password',
    PASSWORD_LABEL_VALUE = '*********',

    LOGIN_BUTTON_VALUE = 'Ir al Login',
